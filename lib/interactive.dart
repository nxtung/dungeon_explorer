...
class _InteractiveScreenState extends State<InteractiveScreen>
  ...
  printImageInfo() async {
    Image image = Image.asset("assets/map.png");
    ImageInfo info = await getImageInfo(image);
    print(info.image.height);
  }

  otherGetImageInfo() async {
    final img = await rootBundle.load("assets/map.png");
...
// Stop a running reset to home transform animation.
  ...
  Future<int> findRoomByPoint(Offset p) async {
    ...
    for (var r in allRoom['Datas']) {
      ...
      double xMax = 0.0, xMin = 1023.0, yMax = 0.0, yMin = 1303.0;
